...
def data2xyz_np(pc):
    xs = np.reshape(pc.pc_data['x'], (-1, 1))#n*1
...
def evaluate(gt, estimate, voxelsize=0.1):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt', default='/media/robot-nuc12/T7/bag_map/hash_map/exp/00/original.pcd', type=str)
    parser.add_argument('--est', default='/media/robot-nuc12/T7/bag_map/hash_map/exp/00/RH_Map_voxelsize_1.6.pcd', type=str)
    parser.add_argument('--size', default=0.1, type=float)
    # parser.add_argument('--gt', default='/media/robot-nuc12/T7/bag_map/hash_map/exp/00/removert/OriginalNoisyMapGlobal.pcd', type=str)
    # parser.add_argument('--est', default='/media/robot-nuc12/T7/bag_map/hash_map/exp/00/removert/map_static/StaticMapMapsideGlobalResX1.000000.pcd', type=str)
    # parser.add_argument('--size', default=0.05, type=float)
    ...
    voxelsize=args.size
    evaluate(gt_data, target_data, voxelsize=args.size)
